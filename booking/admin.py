...
class AppointmentAdmin(admin.ModelAdmin):
    list_display = ('customer_name', 'phone_number', 'customer', 'service', 'technician', 'slot', 'created_at')
    list_filter = ('slot__date', 'technician')
    search_fields = ('customer_name', 'phone_number', 'customer__username', 'technician__username')
    ordering = ('-created_at',)
